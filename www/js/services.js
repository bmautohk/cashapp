...
.factory('sharedFilterService', [function($scope){

	var obj = {};
    obj.str = "http://localhost/pm/api/getCashes";
	obj.sort = "";
	obj.search = "";
	obj.category = "";
	obj.till=100;
	...
	obj.getUrl=function(){
		...
		obj.till=obj.till;
		obj.str= "http://localhost/pm/api/getCashes?page=0&page_size="+obj.till+"&userid="+sessionStorage.getItem('loggedin_name'); // pass the value to url
